...
export class Tag {
    ...
    static readonly RXJS = new Tag('rxjs', '#5a6781');
    ...
    static readonly JEST = new Tag('Jest', '#457189');
    static readonly CYPRESS = new Tag('Cypress', '#457189' );
    static readonly SWAGGER = new Tag('Swagger', '#457134' );
    static readonly SPRINGDATA = new Tag('Spring Data', '#457534' )
